        ...
        <el-form ref="form" label-width="80px">
          <el-row :gutter="10" v-for="(item, index) in this.form" :key="index" class="el-row">
            <el-col :span="21">
              ...
              <el-col :span="10" v-if="thirdOptions(item).length > 0 && ['10', '20'].includes(thirdOptions(item)[0].showType)">
                <el-input type="text" v-model="form[index].filterValue"></el-input>
              </el-col>
              <el-col :span="10" v-if="thirdOptions(item).length > 0 && ['40'].includes(thirdOptions(item)[0].showType)">
              ...
              <el-col :span="10" v-if="thirdOptions(item).length > 0 && ['30'].includes(thirdOptions(item)[0].showType)">
                <el-date-picker
            ...
            <el-col :span="3">
              <el-button class="more_button" size="small" @click="handleClickSure">确认</el-button>
            </el-col>
          </el-row>
        </el-form>
      </div>
